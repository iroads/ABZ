...
public class Recept {
    ...
    Double[] PP_Target = new Double[]{10.0, 13.0, 16.0, 21.0, 28.0, 41.0, 54.0, 74.0, 84.0, 98.0, 100.0};
    ...
    public void CalculateCustom(Double SOD1, Double SOD2) {
    ...
    public void AutoPodbor() {
        ...
        for (int n = 0; n < 11; n++) {
            PP_TargetPlus[n] = PP_Target[n] + 1;
            PP_TargetMinus[n] = PP_Target[n] - 1;
        }
        ...
        for (int i = 0; i <= 100; i++) {
            ...
            for (int j = 0; j <= 100; j++) {
                ...
                if ((i + j) == 100) {
                    CalculateCustom((double) i, (double) j);
